...
void MySetupAnalysisPluginAliEn(AliAnalysisAlien *plugin) {
  ...
  //
  //
  //   // Method 1: Create automatically XML collections using alien 'find'
  //   command.
  ...
  //   plugin->SetDataPattern("*ESDs/pass2/*ESDs.root"); // real data check reco
  //   pass and data base directory
  //   plugin->SetRunPrefix("000");   // real data
  //   runs = "117222, 117220, 117116, 117112, 117109, 117099, 117092, 117063,
  //   117060, 117059, 117053, 117052, 117050, 117048, 116643, 116574, 116571,
  //   116562, 116403, 116402, 116288, 116102, 115414, 115401, 115393, 115193,
  //   115186, 114931";
  ...
  // //     plugin->SetRunPrefix("000");   // real data
  //
  // //    plugin->SetDataPattern("*tag.root");  // Use ESD tags (same applies
  // for AOD's)
  ...
  // //    plugin->SetDataPattern("*ESDs.root"); // real data check reco pass
  // and data base directory
  // //    plugin->SetRunPrefix("");   // sim data
  // //    runs = "120829,120825";
  // // //     runs =
  // "120829,120825,120824,120823,120822,120821,120820,120758,120750";
  // //    plugin->SetSplitMaxInputFileNumber(10);
  //
  plugin->SetGridDataDir("/alice/data/2010/LHC10h");
  plugin->SetDataPattern("*ESDs/pass2/*ESDs.root"); // real data check reco pass
                                                    // and data base directory
  plugin->SetRunPrefix("000");                      // real data
  ...
  // root file)
  // // If no path mentioned data is supposed to be in the work directory (see
  // SetGridWorkingDir())
  // // XML collections added via this method can be combined with the first
  // method if
  ...
  plugin->SetAdditionalLibs(
    "AliRsnTaskEventPlaneTest.h AliRsnTaskEventPlaneTest.cxx");
  ...
  // // Optionally set maximum number of input files/subjob (default 100, put 0
  // to ignore). The optimum for an analysis
  // // is correlated with the run time - count few hours TTL per job, not
  // minutes !
  // //    plugin->SetSplitMaxInputFileNumber(1);
