...
AliRsnOutTaskRooFit::AliRsnOutTaskRooFit(const char *name, const char *title) : AliRsnOutTask(name,title),fInput(0),fFitResults(0) {
...
//	maxFit = 1.050;
	...
	fitResult = model.chi2FitTo(data, Save(),SumW2Error(kTRUE), Range(minFit, maxFit),PrintLevel(-1)) ;
